...
screen = pygame.display.set_mode((image_width*5, image_height*5)) #upscale drawn image by 5
...
for y in range(image_height):
   for x in range(image_width):
        (r, g, b, _) = screen.get_at((x, y)) #check RGB value of pixel
        ...
        if x == 0 and y ==0: #check left corner pixel
            if (r,g, b, _) == (250,45, 208): #check if that pixel is magenta
                ...
                d = int(b/40)
                while a > 0:
                    pygame.draw.circle(screen, (255,0,0),(random.randint((x*5)-15,x*5),random.randint((y*5)-15,y*5)),1)
                    a -=1
                while c > 0:
                    pygame.draw.circle(screen, (0,255,0),(random.randint((x*5)-15,x*5),random.randint((y*5)-15,y*5)),1)
                    c -=1
                while d > 0:
                    pygame.draw.circle(screen, (0,0,255),(random.randint((x*5)-15,x*5),random.randint((y*5)-15,y*5)),1)
                    d -=1
...
pygame.image.save(screen,"suqintingDrawing.png") #save image
